...
return (
  ...
  <div className="social-links"><Link className="social-link" to="https://www.facebook.com/Netflixmx" aria-label="facebook"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-icon svg-icon-facebook-logo">
  ...
  <Link className="social-link" to="https://www.instagram.com/NetflixLAT"  aria-label="instagram"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-icon svg-icon-instagram-logo">
  ...
  <Link className="social-link" to="https://www.youtube.com/channel/UC5ZiUaIJ2b5dYBYGf5iEUrA" aria-label="youtube"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-icon svg-icon-youtube-logo">
  ...
  <ul className="member-footer-links">
    <li className="member-footer-link-wrapper">
      <Link className="member-footer-link" to="/browse/audio-description">
        <span className="member-footer-link-content">Audio descriptivo</span></Link>
    
        </li>
        <li className="member-footer-link-wrapper">
          <Link className="member-footer-link" to="https://help.netflix.com/">
            <span className="member-footer-link-content">Centro de ayuda</span></Link>
            </li>
            <li className="member-footer-link-wrapper">
              <Link className="member-footer-link" to="/redeem">
                ...
                <li className="member-footer-link-wrapper">
                  <Link className="member-footer-link" to="https://media.netflix.com/">
                    <span className="member-footer-link-content">Prensa</span></Link>
                    </li>
                    <li className="member-footer-link-wrapper">
                      <Link className="member-footer-link" to="http://ir.netflix.com/">
                        ...
                        <li className="member-footer-link-wrapper">
                          <Link className="member-footer-link" to="https://jobs.netflix.com/">
                            <span className="member-footer-link-content">Empleo</span></Link>
                            </li>
                            <li className="member-footer-link-wrapper">
                              <Link className="member-footer-link" to="https://help.netflix.com/legal/termsofuse">
                                <span className="member-footer-link-content">Términos de uso</span></Link>
                                </li>
                                <li className="member-footer-link-wrapper">
                                  <Link className="member-footer-link" to="https://help.netflix.com/legal/privacy">
                                    <span className="member-footer-link-content">Privacidad</span></Link>
                                    </li>
                                    <li className="member-footer-link-wrapper">
                                      <Link className="member-footer-link" to="https://help.netflix.com/legal/notices">
                                        <span className="member-footer-link-content">Avisos legales</span></Link>
                                        </li>
                                        <li className="member-footer-link-wrapper">
                                          <Link className="member-footer-link" to="/Cookies">
                                            <span className="member-footer-link-content">Preferencias de cookies</span></Link>
                                            </li>
                                            <li className="member-footer-link-wrapper">
                                              <Link className="member-footer-link" to="https://help.netflix.com/legal/corpinfo">
                                                <span className="member-footer-link-content">Información corporativa</span></Link>
                                                </li>
                                                <li className="member-footer-link-wrapper">
                                                  <Link className="member-footer-link" to="https://help.netflix.com/contactus">
                                                    <span className="member-footer-link-content">Contáctanos</span></Link>
                                                    </li>
                                                    </ul>
