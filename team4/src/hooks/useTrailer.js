...
import { getSeriesClips } from '../functions/movieApi'

const useTrailer = (id, showInMobile = true, height = null, width = null) => {
    ...
    const getClip = async (id) => {        
        ...
        const movieClips = await getSeriesClips(id, language);
